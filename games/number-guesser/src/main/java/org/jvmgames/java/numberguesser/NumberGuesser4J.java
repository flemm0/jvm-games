...
public class NumberGuesser4J implements Game {
    ...
    @Override
    public String name() {
        return "Number Guesser (Java)";
    }

    @Override
    public String description() {
        return "Guess the number I'm thinking of!";
    }
    ...
    public boolean playOneGame() {
      ...
      """.formatted(game.getBound()));
        ...
        if (game.isWon()) {
            System.out.println(
                "Congratulations! You've guessed the number in " + game.getGuessCount() + " guesses.");
            System.out.println("⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️");
        } else {
            System.out.println(
                "Game over! You've used all your guesses. The number was " + game.getSecretNumber() + ".");
            System.out.println("😂🫵🏼");
        }
