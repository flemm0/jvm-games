...
public class ConsoleHandler {
    ...
    public static int promptForMove(List<Integer> openPositions, Mark currentPlayer, Mark humanPlayer) {
        ...
        if (currentPlayer == humanPlayer) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (move >= 1 && move <= 9 && openPositions.contains(move)) {
                        ...
                        System.out.println(
                            "That position is already taken. Please choose an open position.");
                    }
            ...
            // if game mode is set to easy, computer picks random open position
            int move = openPositions.get(random.nextInt(openPositions.size()));
            // else if game is hard, computer uses minimax algorithm to pick best move
            return move;
        }
    }
